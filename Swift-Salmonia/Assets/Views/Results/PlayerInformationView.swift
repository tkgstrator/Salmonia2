...
struct PlayerInformationView: View {
    ...
    var body: some View {
        ...
        .onAppear() {
            SplatNet2.getPlayerInformationFromSplatNet2(nsaid: self.playerid) { response in
            ...
            SplatNet2.getPlayerInformationFromSalmonStats(nsaid: self.playerid) { response in
