...
struct ResultView: View {
    ...
    private var ResultOverview: some View {
        ZStack {
            ...
            .frame(height: 160)
            .mask(URLImage(URL(string: "https://app.splatoon2.nintendo.net/images/bundled/94aaee8dac73aa5f7cb0a31dfd21958d.png")!, content: {$0.image.resizable()}))
            VStack(alignment: .leading, spacing: 0) {
                ZStack {
                    HStack {
                        ZStack(alignment: .leading) {
                            URLImage(URL(string: "https://app.splatoon2.nintendo.net/images/bundled/e0ef914978d3318fa3ec2afbfa64c794.png")!, content: {$0.image.renderingMode(.template).resizable().aspectRatio(contentMode: .fill)})
